          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Image.asset(ImageApp.matisseLogo, width: 264, height: 72, fit: BoxFit.cover,),

                const SizedBox(height: 20),

                SetupTextWidget(titleLabel: "Dental Shade Matching Made Easy",
                    textColor: Colors.white, textAlign: TextAlign.start
                    , fontSize: 16, font: FontApp.robotoRegular, maxLine: 1),
